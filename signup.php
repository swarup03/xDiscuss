<?php echo'<div class="modal fade" id="signupModal" tabindex="-1" aria-labelledby="signupModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="handlesingup.php" method="POST">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="CexampleInputPassword1" class="form-label">Conform Password</label>
